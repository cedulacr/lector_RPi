...
extern "C" {
	...
	* @sa CFunctions PublicRuntimeSettings
	*/
	DBR_API int  DBR_InitRuntimeSettingstWithString(void* hBarcode, const char* pszContent, ConflictMode emSettingPriority, char szErrorMsgBuffer[], int nErrorMsgBufferLen);
